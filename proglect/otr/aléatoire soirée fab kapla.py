...
while ans!="end" and ans!="stop":
      ...
      if ans=="4" or ans=="end" or ans=="stop":
            ...
            print("\n                     "+TM[rand])
      if ans=="5":
            print("\nla chance est de ton coté, pour l'instant...")
      i+=1
