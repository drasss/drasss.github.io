...
if adj=="y" or adj=="Y":
    jo = input("quel est le numéro de ce jour ? ")
    mo = input("quel mois sommes-nous ? ")
    an = input("quelle année sommes-nous ? ")
    print("quel jour sommes nous ?")
    cal = input("lundi=1  mardi=2 etc...  ")
else:
    jo=aut[2]
    mo=aut[1]
    an=aut[0]
...
if n==1:
    jap = jap +60
                        ...
                        #on determine quel numero du jour correspond au premier jour
