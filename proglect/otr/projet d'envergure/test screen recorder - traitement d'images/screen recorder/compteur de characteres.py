#PythonGeeks Guide to create a simple Python screen recorder
...
def record_screen():
   ...
   screen_cap_writer = cv2.VideoWriter('screen_recorded.avi',cv2.VideoWriter_fourcc('M','J','P','G'), 30, (shape[1], shape[0]))
